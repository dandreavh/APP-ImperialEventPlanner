...
export class HomeComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.eventos.push(this.eventoNew1);
        this.eventos.push(this.eventoNew2);
        this.eventos.push(this.eventoNew3);
        this.eventos.push(this.eventoNew4);
        this.eventos.push(this.eventoNew5);
        this.eventos.push(this.eventoNew6);
